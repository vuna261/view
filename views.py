...
from rbi.process.RBI import DM_CAL,CA_CAL,pofConvert
from datetime import datetime
from rbi.process.WebUI import location
from rbi.process.WebUI import roundData
from rbi.process.File import export_data
from rbi.process.WebUI import date2Str
from django.core.files.storage import FileSystemStorage
from django.conf import settings
from rbi.process.File import import_data as ExcelImport
from rbi.process.RBI import fastCalulate as ReCalculate
import time
import logging
...
def upload(request, siteID):
    try:
        ...
        raise Http404
    return render(request, 'FacilityUI/facility/uploadData.html', {'siteID': siteID})
